...
class Person1 (val name : String){
     ...
     private fun createCard(): Card1 {
             val numbersSet15 = mutableSetOf<Int>()
             val numbersSet1 = mutableSetOf<Int>()
             val numbersSet2 = mutableSetOf<Int>()
             val numbersSet3 = mutableSetOf<Int>()
             //for (i in 1..15) {
